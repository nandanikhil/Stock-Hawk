...
//        sp.unregisterOnSharedPreferenceChangeListener(this);
    ...
    public void networkToast() {
        Snackbar.make(cordinatorLayout, R.string.network_toast, Snackbar.LENGTH_SHORT).show();
        Utils.setSharedPreference(mContext, true);
    }
...
//    Toast.makeText(mContext, getString(R.string.network_toast), Toast.LENGTH_SHORT).show();
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if (key.equals(getString(R.string.shared_pref_key)) && !sharedPreferences.getBoolean(getString(R.string.shared_pref_key), false)) {
            Snackbar.make(cordinatorLayout, getString(R.string.nostocks), Snackbar.LENGTH_SHORT).show();
            Utils.setSharedPreference(mContext, true);
        }
    }
